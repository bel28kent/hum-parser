...
#|
	...
	Placeholders are given as "...".

	Do not attempt to requires this file; the placeholders will cause parsing errors.
	Instead, copy and paste the appropriate template into the file.
|#
