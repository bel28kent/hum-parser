...
; hfile->hgraph
(check-expect (hfile->hgraph one-spine-no-splits-hfile)
              (hgraph
               (root
...
(check-expect (hfile->hgraph one-spine-one-split-hfile)
              (hgraph
               (root
                (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                            (leaf (token "*clefG2" CLEF 1))
...
(check-expect (hfile->hgraph one-spine-two-splits-hfile)
...
(check-expect (hfile->hgraph two-spines-no-splits-hfile)
              (hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                        (leaf (token "*clefG2" CLEF 1))
                                        (leaf (token "*k[]" KEY-SIG 2))
                                        (leaf (token "*a:" KEY-LABEL 3))
                                  ...
                                  (list (leaf (token "**dynam" EXCLUSIVE-INTERPRETATION 0))
                                        ...
                                        (leaf (token "==" MEASURE 10))
                                        (leaf (token "*-" SPINE-TERMINATOR 11)))))))
(check-expect (hfile->hgraph two-spines-one-splits-hfile)
              (hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                        (leaf (token "*clefG2" CLEF 1))
                                        (leaf (token "*k[]" KEY-SIG 2))
                                        (leaf (token "*a:" KEY-LABEL 3))
                                  ...
                                  (list (leaf (token "**dynam" EXCLUSIVE-INTERPRETATION 0))
                                        ...
                                        (leaf (token "==" MEASURE 12))
                                        (leaf (token "*-" SPINE-TERMINATOR 13)))))))
(check-expect (hfile->hgraph two-spines-both-split-hfile)
              (hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                        (leaf (token "*clefG2" CLEF 1))
                                        (leaf (token "*k[]" KEY-SIG 2))
                                        (leaf (token "*a:" KEY-LABEL 3))
                                  ...
                                  (list (leaf (token "**dynam" EXCLUSIVE-INTERPRETATION 0))
                                        ...
                                        (leaf (token "==" MEASURE 14))
                                        (leaf (token "*-" SPINE-TERMINATOR 15)))))))
(check-expect (hfile->hgraph three-spines-two-splits-not-consecutive-hfile)
              (hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                  ...
                                  (list (leaf (token "**dynam" EXCLUSIVE-INTERPRETATION 0))
                                        ...
                                        (leaf (token "==" MEASURE 51))
                                        (leaf (token "*-" SPINE-TERMINATOR 52)))))))
(check-expect (hfile->hgraph three-spines-two-splits-not-consecutive-2-hfile)
              (hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                        (leaf (token "*staff2" STAFF-NUMBER 1))
                                        (leaf (token "*Ipiano" INSTRUMENT-CLASS 2))
                                        (leaf (token "*clefF4" CLEF 3))
                                  ...
                                  (list (leaf (token "**dynam" EXCLUSIVE-INTERPRETATION 0))
                                        ...
                                        (leaf (token "==" MEASURE 51))
                                        (leaf (token "*-" SPINE-TERMINATOR 52)))))))
(check-expect (hfile->hgraph four-cases-hfile)
              (hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
...
(check-expect (hfile->hgraph parent-scriabin-hfile)
              (hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                        (parent (token "*^" SPINE-SPLIT 1)
