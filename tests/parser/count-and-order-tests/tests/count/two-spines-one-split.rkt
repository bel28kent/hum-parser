...
(define NULL-18-1 (token-node (token "*" NULL-INTERPRETATION 18 1) (box-immutable J-19-1)))
(define 4c-17-0 (token-node (token "4c" SPINE-DATA 17 0) (box-immutable NULL-18-0)))
(define 4c-17-1 (token-node (token "4c" SPINE-DATA 17 1) (box-immutable NULL-18-1)))
...
(define NULL-6-1 (token-node (token "*" NULL-INTERPRETATION 6 1) (box-immutable 4c-7-1)))
...
(define TERM-21-1 (terminator-node (token "*-" SPINE-TERMINATOR 21 1)))
(define M-20-1 (token-node (token "==" MEASURE 20 1) (box-immutable TERM-21-1)))
(define NULL-19-2 (token-node (token "*" NULL-INTERPRETATION 19 2) (box-immutable M-20-1)))
(define J-18-2 (token-node (token "*v" SPINE-JOIN 18 2) (box-immutable NULL-19-2)))
(define J-18-3 (token-node (token "*v" SPINE-JOIN 18 3) (box-immutable NULL-19-2)))
(define 4c-17-2 (token-node (token "4c" SPINE-DATA 17 2) (box-immutable J-18-2)))
(define 4c-17-3 (token-node (token "4c" SPINE-DATA 17 3) (box-immutable J-18-3)))
...
(define 4c-9-3 (token-node (token "4c" SPINE-DATA 9 3) (box-immutable M-10-3)))
