...
(check-expect (path->hfile "../../data/count/three-spines-no-splits.krn")
              (hfile (list (record "**kern\t**kern\t**kern"
                           ...
                           (record "*clefG2\t*clefG2\t*clefG2" TOKEN (list (token "*clefG2" 'Clef 1 0)
                                   ...
                                   1)
                           (record "*k[]\t*k[]\t*k[]" TOKEN (list (token "*k[]" 'KeySignature 2 0)
                                                                  (token "*k[]" 'KeySignature 2 1)
                                                                  (token "*k[]" 'KeySignature 2 2))
                                   2)
                           (record "*a:\t*a:\t*a:" TOKEN (list (token "*a:" 'KeyLabel 3 0)
                                                               (token "*a:" 'KeyLabel 3 1)
                                                               (token "*a:" 'KeyLabel 3 2))
                                   3)
                           (record "*M3/4\t*M3/4\t*M3/4" TOKEN (list (token "*M3/4" 'TimeSignature 4 0)
                           ...
                           (record "==\t==\t==" TOKEN (list (token "==" 'Measure 16 0)
                                                            ...
                                                            (token "==" 'Measure 16 2))
                                   16)
                           (record "*-\t*-\t*-" TOKEN (list (token "*-" 'SpineTerminator 17 0)
