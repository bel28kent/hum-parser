...
(define NULL-25-2 (token-node (token "*" 'NullInterpretation 25 2) (box-immutable J-26-2)))
...
(define NULL-24-2 (token-node (token "*" 'NullInterpretation 24 2) (box-immutable NULL-25-2)))
...
(define NULL-7-2 (token-node (token "*" 'NullInterpretation 7 2) (box-immutable NULL-8-2)))
...
(define J-25-3 (token-node (token "*v" 'SpineJoin 25 3) (box-immutable NULL-26-3)))
(define J-25-4 (token-node (token "*v" 'SpineJoin 25 4) (box-immutable NULL-26-3)))
(define NULL-24-3 (token-node (token "*" 'NullInterpretation 24 3) (box-immutable J-25-3)))
(define J-24-4 (token-node (token "*v" 'SpineJoin 24 4) (box-immutable J-25-4)))
(define J-24-5 (token-node (token "*v" 'SpineJoin 24 5) (box-immutable J-25-4)))
...
(define NULL-23-5 (token-node (token "*" 'NullInterpretation 23 5) (box-immutable J-24-5)))
...
(define NULL-22-5 (token-node (token "*" 'NullInterpretation 22 5) (box-immutable NULL-23-5)))
...
(define NULL-9-5 (token-node (token "*" 'NullInterpretation 9 5) (box-immutable NULL-10-5)))
...
(define S-7-3 (split-node (token "*^" 'SpineSplit 7 3)
                          (box-immutable NULL-8-3)
                          (box-immutable S-8-4)))
(define NULL-6-2 (token-node (token "*" 'NullInterpretation 6 2) (box-immutable S-7-3)))
...
(define TERM-29-2 (terminator-node (token "*-" 'SpineTerminator 29 2)))
(define M-28-2 (token-node (token "==" 'Measure 28 2) (box-immutable TERM-29-2)))
(define NULL-27-3 (token-node (token "*" 'NullInterpretation 27 3) (box-immutable M-28-2)))
(define NULL-26-4 (token-node (token "*" 'NullInterpretation 26 4) (box-immutable NULL-27-3)))
(define NULL-25-5 (token-node (token "*" 'NullInterpretation 25 5) (box-immutable NULL-26-4)))
(define NULL-24-6 (token-node (token "*" 'NullInterpretation 24 6) (box-immutable NULL-25-5)))
(define J-23-6 (token-node (token "*v" 'SpineJoin 23 6) (box-immutable NULL-24-6)))
(define J-23-7 (token-node (token "*v" 'SpineJoin 23 7) (box-immutable NULL-24-6)))
(define NULL-22-6 (token-node (token "*" 'NullInterpretation 22 6) (box-immutable J-23-6)))
(define J-22-7 (token-node (token "*v" 'SpineJoin 22 7) (box-immutable J-23-7)))
(define J-22-8 (token-node (token "*v" 'SpineJoin 22 8) (box-immutable J-23-7)))
(define 4c-21-6 (token-node (token "4c" 'SpineData 21 6) (box-immutable NULL-22-6)))
(define 4c-21-7 (token-node (token "4c" 'SpineData 21 7) (box-immutable J-22-7)))
(define 4c-21-8 (token-node (token "4c" 'SpineData 21 8) (box-immutable J-22-8)))
...
(define 4c-20-8 (token-node (token "4c" 'SpineData 20 8) (box-immutable 4c-21-8)))
...
(define 4c-17-8 (token-node (token "4c" 'SpineData 17 8) (box-immutable M-18-8)))
...
(define 4c-16-8 (token-node (token "4c" 'SpineData 16 8) (box-immutable 4c-17-8)))
...
(define 4c-13-8 (token-node (token "4c" 'SpineData 13 8) (box-immutable M-14-8)))
...
(define 4c-12-8 (token-node (token "4c" 'SpineData 12 8) (box-immutable 4c-13-8)))
...
(define 4c-11-8 (token-node (token "4c" 'SpineData 11 8) (box-immutable 4c-12-8)))
(define NULL-10-6 (token-node (token "*" 'NullInterpretation 10 6) (box-immutable 4c-11-6)))
(define S-10-7 (split-node (token "*^" 'SpineSplit 10 7)
                           (box-immutable 4c-11-7)
                           (box-immutable 4c-11-8)))
(define S-9-6 (split-node (token "*^" 'SpineSplit 9 6)
                          (box-immutable NULL-10-6)
                          (box-immutable S-10-7)))
(define NULL-8-5 (token-node (token "*" 'NullInterpretation 8 5) (box-immutable S-9-6)))
              ...
              (hfile (list (record "**kern\t**kern\t**kern" 'ExclusiveInterpretation
                           ...
                           (record "*\t*\t*\t*\t*\t*\t*\t*^" 'TandemInterpretation
                                   (list (token "*" 'NullInterpretation 10 0)
                                         ...
                                         (token "*" 'NullInterpretation 10 6)
                                         (token "*^" 'SpineSplit 10 7))
                                   10)
                           ...
                           (record "4c\t4c\t4c\t4c\t4c\t4c\t4c\t4c\t4c" 'Token
                                   (list (token "4c" 'SpineData 13 0)
                                         ...
                                         (token "4c" 'SpineData 13 8))
                                   13)
                           (record "=2\t=2\t=2\t=2\t=2\t=2\t=2\t=2\t=2" 'Measure
                           ...
                           (record "4c\t4c\t4c\t4c\t4c\t4c\t4c\t4c\t4c" 'Token
                                   (list (token "4c" 'SpineData 17 0)
                                         ...
                                         (token "4c" 'SpineData 17 8))
                                   17)
                           (record "=3\t=3\t=3\t=3\t=3\t=3\t=3\t=3\t=3" 'Measure
                           ...
                           (record "*\t*\t*\t*\t*\t*\t*\t*v\t*v" 'TandemInterpretation
                                   (list (token "*" 'NullInterpretation 22 0)
                                         ...
                                         (token "*" 'NullInterpretation 22 6)
                                         (token "*v" 'SpineJoin 22 7)
                                         (token "*v" 'SpineJoin 22 8))
                                   22)
                           (record "*\t*\t*\t*\t*\t*\t*v\t*v" 'TandemInterpretation
                                   (list (token "*" 'NullInterpretation 23 0)
                                         ...
                                         (token "*" 'NullInterpretation 23 5)
                                         (token "*v" 'SpineJoin 23 6)
                                         (token "*v" 'SpineJoin 23 7))
                                   23)
                           (record "*\t*\t*\t*\t*v\t*v\t*" 'TandemInterpretation
              ...
              (list (global-spine 'Kern
                    ...
                    (global-spine 'Kern
                                  (list (list (token "**kern" 'ExclusiveInterpretation 0 1))
                                        ...
                                        (list (token "4c" 'SpineData 19 3)
                                              (token "4c" 'SpineData 19 4)
                                              (token "4c" 'SpineData 19 5))
                                        (list (token "4c" 'SpineData 20 3)
                                              (token "4c" 'SpineData 20 4)
                                              (token "4c" 'SpineData 20 5))
                                        (list (token "4c" 'SpineData 21 3)
                                              (token "4c" 'SpineData 21 4)
                                              (token "4c" 'SpineData 21 5))
                                        (list (token "*" 'NullInterpretation 22 3)
                                              (token "*" 'NullInterpretation 22 4)
                                              (token "*" 'NullInterpretation 22 5))
                                        (list (token "*" 'NullInterpretation 23 3)
                                              (token "*" 'NullInterpretation 23 4)
                                              (token "*" 'NullInterpretation 23 5))
                                        (list (token "*" 'NullInterpretation 24 3)
                                              (token "*v" 'SpineJoin 24 4)
                                              (token "*v" 'SpineJoin 24 5))
                                        (list (token "*v" 'SpineJoin 25 3)
                                              (token "*v" 'SpineJoin 25 4))
                    ...
                    (global-spine 'Kern
                                  (list (list (token "**kern" 'ExclusiveInterpretation 0 2))
                                        ...
                                        (list (token "*^" 'SpineSplit 9 6))
                                        (list (token "*" 'NullInterpretation 10 6)
                                              (token "*^" 'SpineSplit 10 7))
                                        (list (token "4c" 'SpineData 11 6)
                                              (token "4c" 'SpineData 11 7)
                                              (token "4c" 'SpineData 11 8))
                                        (list (token "4c" 'SpineData 12 6)
                                              (token "4c" 'SpineData 12 7)
                                              (token "4c" 'SpineData 12 8))
                                        (list (token "4c" 'SpineData 13 6)
                                              (token "4c" 'SpineData 13 7)
                                              (token "4c" 'SpineData 13 8))
                                        (list (token "=2" 'Measure 14 6)
                                              (token "=2" 'Measure 14 7)
                                              (token "=2" 'Measure 14 8))
                                        (list (token "4c" 'SpineData 15 6)
                                              (token "4c" 'SpineData 15 7)
                                              (token "4c" 'SpineData 15 8))
                                        (list (token "4c" 'SpineData 16 6)
                                              (token "4c" 'SpineData 16 7)
                                              (token "4c" 'SpineData 16 8))
                                        (list (token "4c" 'SpineData 17 6)
                                              (token "4c" 'SpineData 17 7)
                                              (token "4c" 'SpineData 17 8))
                                        (list (token "=3" 'Measure 18 6)
                                              (token "=3" 'Measure 18 7)
                                              (token "=3" 'Measure 18 8))
                                        (list (token "4c" 'SpineData 19 6)
                                              (token "4c" 'SpineData 19 7)
                                              (token "4c" 'SpineData 19 8))
                                        (list (token "4c" 'SpineData 20 6)
                                              (token "4c" 'SpineData 20 7)
                                              (token "4c" 'SpineData 20 8))
                                        (list (token "4c" 'SpineData 21 6)
                                              (token "4c" 'SpineData 21 7)
                                              (token "4c" 'SpineData 21 8))
                                        (list (token "*" 'NullInterpretation 22 6)
                                              (token "*v" 'SpineJoin 22 7)
                                              (token "*v" 'SpineJoin 22 8))
                                        (list (token "*v" 'SpineJoin 23 6)
                                              (token "*v" 'SpineJoin 23 7))
                                        (list (token "*" 'NullInterpretation 24 6))
                                        (list (token "*" 'NullInterpretation 25 5))
                                        (list (token "*" 'NullInterpretation 26 4))
                                        (list (token "*" 'NullInterpretation 27 3))
                                        (list (token "==" 'Measure 28 2))
                                        (list (token "*-" 'SpineTerminator 29 2)))
                                  2)))
(check-expect (hgraph->hfile (hgraph (root (list (list (leaf (token "**kern" 'ExclusiveInterpretation 0 0))
                                                       ...
                                                       (parent (token "*^" 'SpineSplit 5 0)
                                                               ...
                                                               (list (parent (token "*^" 'SpineSplit 6 1)
                                                                             ...
                                                                             (list (leaf (token "*" 'NullInterpretation 7 2))
                                                                                   (leaf (token "*" 'NullInterpretation 8 2))
                                                 ...
                                                 (list (leaf (token "**kern" 'ExclusiveInterpretation 0 1))
                                                       ...
                                                       (parent (token "*^" 'SpineSplit 7 3)
                                                               ...
                                                               (list (parent (token "*^" 'SpineSplit 8 4)
                                                                             ...
                                                                             (list (leaf (token "*" 'NullInterpretation 9 5))
                                                                                   ...
                                                                                   (leaf (token "*" 'NullInterpretation 23 5))
                                                                                   (leaf (token "*v" 'SpineJoin 24 5))))
                                                                     (leaf (token "*v" 'SpineJoin 25 4))))
                                                 ...
                                                 (list (leaf (token "**kern" 'ExclusiveInterpretation 0 2))
                                                       ...
                                                       (parent (token "*^" 'SpineSplit 9 6)
                                                               (list (leaf (token "*" 'NullInterpretation 10 6))
                                                                     (leaf (token "4c" 'SpineData 11 6))
                                                                     ...
                                                                     (leaf (token "*" 'NullInterpretation 22 6))
                                                                     (leaf (token "*v" 'SpineJoin 23 6)))
                                                               (list (parent (token "*^" 'SpineSplit 10 7)
                                                                             ...
                                                                             (list (leaf (token "4c" 'SpineData 11 8))
                                                                                   (leaf (token "4c" 'SpineData 12 8))
                                                                                   (leaf (token "4c" 'SpineData 13 8))
                                                                                   (leaf (token "=2" 'Measure 14 8))
                                                                                   (leaf (token "4c" 'SpineData 15 8))
                                                                                   (leaf (token "4c" 'SpineData 16 8))
                                                                                   (leaf (token "4c" 'SpineData 17 8))
                                                                                   (leaf (token "=3" 'Measure 18 8))
                                                                                   (leaf (token "4c" 'SpineData 19 8))
                                                                                   (leaf (token "4c" 'SpineData 20 8))
                                                                                   (leaf (token "4c" 'SpineData 21 8))
                                                                                   (leaf (token "*v" 'SpineJoin 22 8))))
                                                                     (leaf (token "*v" 'SpineJoin 23 7))))
                                                       (leaf (token "*" 'NullInterpretation 24 6))
                                                       ...
                                                       (leaf (token "*-" 'SpineTerminator 29 2)))))))
...
(check-expect (tokens->records (list (list (token "**kern" 'ExclusiveInterpretation 0 0)
                                ...
                                (list (token "*-" 'SpineTerminator 29 0)
                                      (token "*-" 'SpineTerminator 29 1)
                                      (token "*-" 'SpineTerminator 29 2))))
              (list (record "**kern\t**kern\t**kern" 'ExclusiveInterpretation
                            (list (token "**kern" 'ExclusiveInterpretation 0 0)
                                  (token "**kern" 'ExclusiveInterpretation 0 1)
                                  (token "**kern" 'ExclusiveInterpretation 0 2))
                            0)
