...
(check-expect (path->hfile "../../data/count/two-spines-two-splits.krn")
              (hfile (list (record "**kern\t**kern" 'ExclusiveInterpretation
                                   ...
                                   0)
                           (record "*clefG2\t*clefG2" 'TandemInterpretation (list (token "*clefG2" 'Clef 1 0)
                           ...
                           (record "*M3/4\t*M3/4" 'TandemInterpretation (list (token "*M3/4" 'TimeSignature 4 0)
                                   ...
                                   4)
                           (record "*^\t*" 'TandemInterpretation (list (token "*^" 'SpineSplit 5 0)
                           ...
                           (record "*\t*^\t*\t*" 'TandemInterpretation (list (token "*" 'NullInterpretation 7 0)
                                   ...
                                   7)
                           (record "*\t*\t*\t*\t*^" 'TandemInterpretation (list (token "*" 'NullInterpretation 8 0)
                           ...
                           (record "4c\t4c\t4c\t4c\t4c\t4c" 'Token (list (token "4c" 'SpineData 11 0)
                                   ...
                                   11)
                           (record "=2\t=2\t=2\t=2\t=2\t=2" 'Measure (list (token "=2" 'Measure 12 0)
                           ...
                           (record "4c\t4c\t4c\t4c\t4c\t4c" 'Token (list (token "4c" 'SpineData 15 0)
                                   ...
                                   15)
                           (record "=3\t=3\t=3\t=3\t=3\t=3" 'Measure (list (token "=3" 'Measure 16 0)
                           ...
                           (record "*\t*\t*\t*\t*v\t*v" 'TandemInterpretation (list (token "*" 'NullInterpretation 20 0)
                                   ...
                                   20)
                           (record "*\t*\t*\t*v\t*v" 'TandemInterpretation (list (token "*" 'NullInterpretation 21 0)
                                                                 (token "*" 'NullInterpretation 21 1)
                                                                 (token "*" 'NullInterpretation 21 2)
                                                                 (token "*v" 'SpineJoin 21 3)
                                                                 (token "*v" 'SpineJoin 21 4))
                                   21)
                           (record "*\t*v\t*v\t*" 'TandemInterpretation (list (token "*" 'NullInterpretation 22 0)
                                                              (token "*v" 'SpineJoin 22 1)
                                                              (token "*v" 'SpineJoin 22 2)
                                                              (token "*" 'NullInterpretation 22 3))
                                   22)
                           (record "*v\t*v\t*" 'TandemInterpretation (list (token "*v" 'SpineJoin 23 0)
                                                           (token "*v" 'SpineJoin 23 1)
                                                           (token "*" 'NullInterpretation 23 2))
                                   23)
                           (record "==\t==" 'Measure (list (token "==" 'Measure 24 0)
                                                        (token "==" 'Measure 24 1))
                                   24)
                           (record "*-\t*-" 'TandemInterpretation (list (token "*-" 'SpineTerminator 25 0)
