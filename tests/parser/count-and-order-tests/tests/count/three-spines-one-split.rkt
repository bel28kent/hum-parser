...
(define NULL-20-1 (token-node (token "*" 'NullInterpretation 20 1) (box-immutable J-21-1)))
(define NULL-19-0 (token-node (token "*" 'NullInterpretation 19 0) (box-immutable NULL-20-0)))
(define NULL-19-1 (token-node (token "*" 'NullInterpretation 19 1) (box-immutable NULL-20-1)))
...
(define NULL-6-1 (token-node (token "*" 'NullInterpretation 6 1) (box-immutable NULL-7-1)))
...
(define TERM-23-1 (terminator-node (token "*-" 'SpineTerminator 23 1)))
(define M-22-1 (token-node (token "==" 'Measure 22 1) (box-immutable TERM-23-1)))
(define NULL-21-2 (token-node (token "*" 'NullInterpretation 21 2) (box-immutable M-22-1)))
(define J-20-2 (token-node (token "*v" 'SpineJoin 20 2) (box-immutable NULL-21-2)))
(define J-20-3 (token-node (token "*v" 'SpineJoin 20 3) (box-immutable NULL-21-2)))
(define NULL-19-2 (token-node (token "*" 'NullInterpretation 19 2) (box-immutable J-20-2)))
(define NULL-19-3 (token-node (token "*" 'NullInterpretation 19 3) (box-immutable J-20-3)))
(define 4c-18-2 (token-node (token "4c" 'SpineData 18 2) (box-immutable NULL-19-2)))
(define 4c-18-3 (token-node (token "4c" 'SpineData 18 3) (box-immutable NULL-19-3)))
...
(define NULL-7-2 (token-node (token "*" 'NullInterpretation 7 2) (box-immutable 4c-8-2)))
(define NULL-7-3 (token-node (token "*" 'NullInterpretation 7 3) (box-immutable 4c-8-3)))
...
(define TERM-23-2 (terminator-node (token "*-" 'SpineTerminator 23 2)))
(define M-22-2 (token-node (token "==" 'Measure 22 2) (box-immutable TERM-23-2)))
(define NULL-21-3 (token-node (token "*" 'NullInterpretation 21 3) (box-immutable M-22-2)))
(define NULL-20-4 (token-node (token "*" 'NullInterpretation 20 4) (box-immutable NULL-21-3)))
(define J-19-4 (token-node (token "*v" 'SpineJoin 19 4) (box-immutable NULL-20-4)))
(define J-19-5 (token-node (token "*v" 'SpineJoin 19 5) (box-immutable NULL-20-4)))
(define 4c-18-4 (token-node (token "4c" 'SpineData 18 4) (box-immutable J-19-4)))
(define 4c-18-5 (token-node (token "4c" 'SpineData 18 5) (box-immutable J-19-5)))
...
(define 4c-14-4 (token-node (token "4c" 'SpineData 14 4) (box-immutable M-15-4)))
(define 4c-14-5 (token-node (token "4c" 'SpineData 14 5) (box-immutable M-15-5)))
...
(define 4c-10-4 (token-node (token "4c" 'SpineData 10 4) (box-immutable M-11-4)))
(define 4c-10-5 (token-node (token "4c" 'SpineData 10 5) (box-immutable M-11-5)))
...
(define 4c-8-4 (token-node (token "4c" 'SpineData 8 4) (box-immutable 4c-9-4)))
(define 4c-8-5 (token-node (token "4c" 'SpineData 8 5) (box-immutable 4c-9-5)))
(define S-7-4 (split-node (token "*^" 'SpineSplit 7 4)
                          (box-immutable 4c-8-4)
                          (box-immutable 4c-8-5)))
(define NULL-6-3 (token-node (token "*" 'NullInterpretation 6 3) (box-immutable S-7-4)))
              ...
              (hfile (list (record "**kern\t**kern\t**kern" 'ExclusiveInterpretation
                           ...
                           (record "4c\t4c\t4c\t4c\t4c\t4c" 'Token
                                   (list (token "4c" 'SpineData 8 0)
                                         ...
                                         (token "4c" 'SpineData 8 4)
                                         (token "4c" 'SpineData 8 5))
                                   8)
                           (record "4c\t4c\t4c\t4c\t4c\t4c" 'Token
                           ...
                           (record "*-\t*-\t*-" 'TandemInterpretation
                                   (list (token "*-" 'SpineTerminator 23 0)
                                         (token "*-" 'SpineTerminator 23 1)
                                         (token "*-" 'SpineTerminator 23 2))
                                   23))))
                    ...
                    (global-spine 'Kern
                                  (list (list (token "**kern" 'ExclusiveInterpretation 0 1))
                                        ...
                                        (list (token "4c" 'SpineData 17 2)
                                              (token "4c" 'SpineData 17 3))
                                        (list (token "4c" 'SpineData 18 2)
                                              (token "4c" 'SpineData 18 3))
                                        (list (token "*" 'NullInterpretation 19 2)
                                              (token "*" 'NullInterpretation 19 3))
                                        (list (token "*v" 'SpineJoin 20 2)
                                              (token "*v" 'SpineJoin 20 3))
                                        (list (token "*" 'NullInterpretation 21 2))
                                        (list (token "==" 'Measure 22 1))
                                        (list (token "*-" 'SpineTerminator 23 1)))
                                  1)
                    (global-spine 'Kern
                                  (list (list (token "**kern" 'ExclusiveInterpretation 0 2))
                                        ...
                                        (list (token "*^" 'SpineSplit 7 4))
                                        (list (token "4c" 'SpineData 8 4)
                                              (token "4c" 'SpineData 8 5))
                                        (list (token "4c" 'SpineData 9 4)
                                              (token "4c" 'SpineData 9 5))
                                        (list (token "4c" 'SpineData 10 4)
                                              (token "4c" 'SpineData 10 5))
                                        ...
                                        (list (token "4c" 'SpineData 18 4)
                                              (token "4c" 'SpineData 18 5))
                                        (list (token "*v" 'SpineJoin 19 4)
                                              (token "*v" 'SpineJoin 19 5))
                                        (list (token "*" 'NullInterpretation 20 4))
                                        (list (token "*" 'NullInterpretation 21 3))
                                        (list (token "==" 'Measure 22 2))
                                        (list (token "*-" 'SpineTerminator 23 2)))
                                  2)))
               ...
               (hgraph (root (list (list (leaf (token"**kern" 'ExclusiveInterpretation 0 0))
                                         ...
                                         (parent (token "*^" 'SpineSplit 5 0)
                                                 ...
                                                 (list (leaf (token "*" 'NullInterpretation 6 1))
                                                       (leaf (token "*" 'NullInterpretation 7 1))
                                   ...
                                   (list (leaf (token "**kern" 'ExclusiveInterpretation 0 1))
                                         ...
                                         (parent (token "*^" 'SpineSplit 6 2)
                                                 ...
                                                 (list (leaf (token "*" 'NullInterpretation 7 3))
                                                       ...
                                                       (leaf (token "*" 'NullInterpretation 19 3))
                                                       (leaf (token "*v" 'SpineJoin 20 3))))
                                         (leaf (token "*" 'NullInterpretation 21 2))
                                         (leaf (token "==" 'Measure 22 1))
                                         (leaf (token "*-" 'SpineTerminator 23 1)))
                                   (list (leaf (token "**kern" 'ExclusiveInterpretation 0 2))
                                         ...
                                         (parent (token "*^" 'SpineSplit 7 4)
                                                 (list (leaf (token "4c" 'SpineData 8 4))
                                                       (leaf (token "4c" 'SpineData 9 4))
                                                       ...
                                                       (leaf (token "*v" 'SpineJoin 19 4)))
                                                 (list (leaf (token "4c" 'SpineData 8 5))
                                                       (leaf (token "4c" 'SpineData 9 5))
                                                       ...
                                                       (leaf (token "*v" 'SpineJoin 19 5))))
                                         (leaf (token "*" 'NullInterpretation 20 4))
                                         (leaf (token "*" 'NullInterpretation 21 3))
                                         (leaf (token "==" 'Measure 22 2))
                                         (leaf (token "*-" 'SpineTerminator 23 2)))))))
