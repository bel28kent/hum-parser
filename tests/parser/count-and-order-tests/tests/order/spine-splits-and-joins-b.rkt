...
(define NULL-11-0 (token-node (token "*" 'NullInterpretation 11 0) (box-immutable TERM-12-0)))
(define NULL-10-0 (token-node (token "*" 'NullInterpretation 10 0)
...
(define J-6-0 (token-node (token "*v" 'SpineJoin 6 0) (box-immutable 4c-7-0)))
(define J-6-1 (token-node (token "*v" 'SpineJoin 6 1) (box-immutable 4c-7-0)))
(define J-6-2 (token-node (token "*v" 'SpineJoin 6 2) (box-immutable 4c-7-0)))
...
(define S-1-0 (split-node (token "*^" 'SpineSplit 1 0) (box-immutable NULL-2-0)
                                                       (box-immutable S-2-1)))
...
(define J-11-1 (token-node (token "*v" 'SpineJoin 11 1) (box-immutable TERM-12-1)))
(define J-11-2 (token-node (token "*v" 'SpineJoin 11 2) (box-immutable TERM-12-1)))
...
(define NULL-10-3 (token-node (token "*" 'NullInterpretation 10 3)
...
(define NULL-6-3 (token-node (token "*" 'NullInterpretation 6 3) (box-immutable 4c-7-1)))
(define S-6-4 (split-node (token "*^" 'SpineSplit 6 4) (box-immutable 4c-7-2)
                                                       (box-immutable 4c-7-3)))
(define 4c-5-3 (token-node (token "4c" 'SpineData 5 3) (box-immutable NULL-6-3)))
(define 4c-5-4 (token-node (token "4c" 'SpineData 5 4) (box-immutable S-6-4)))
...
(define NULL-2-2 (token-node (token "*" 'NullInterpretation 2 2) (box-immutable 4c-3-3)))
(define NULL-2-3 (token-node (token "*" 'NullInterpretation 2 3) (box-immutable 4c-3-4)))
(define S-1-1 (split-node (token "*^" 'SpineSplit 1 1) (box-immutable NULL-2-2)
                                                       (box-immutable NULL-2-3)))
(define KERN-0-1 (token-node (token "**kern" 'ExclusiveInterpretation 0 1)
                           (box-immutable S-1-1)))
              ...
              (list (global-spine 'Kern
                    ...
                    (global-spine 'Kern
                                  (list (list (token "**kern" 'ExclusiveInterpretation 0 1))
                                        ...
                                        (list (token "*" 'NullInterpretation 2 2)
                                              (token "*" 'NullInterpretation 2 3))
                                        (list (token "4c" 'SpineData 3 3)
                                              (token "4c" 'SpineData 3 4))
                                        (list (token "4c" 'SpineData 4 3)
                                              (token "4c" 'SpineData 4 4))
                                        (list (token "4c" 'SpineData 5 3)
                                              (token "4c" 'SpineData 5 4))
                                        ...
                                        (list (token "4c" 'SpineData 7 1)
                                              (token "4c" 'SpineData 7 2)
                                              (token "4c" 'SpineData 7 3))
                                        (list (token "4c" 'SpineData 8 1)
                                              (token "4c" 'SpineData 8 2)
                                              (token "4c" 'SpineData 8 3))
                                        (list (token "4c" 'SpineData 9 1)
                                              (token "4c" 'SpineData 9 2)
                                              (token "4c" 'SpineData 9 3))
                                        (list (token "*v" 'SpineJoin 10 1)
                                              (token "*v" 'SpineJoin 10 2)
                                              (token "*" 'NullInterpretation 10 3))
                                        (list (token "*v" 'SpineJoin 11 1)
                                              (token "*v" 'SpineJoin 11 2))
...
(check-expect (extract-spine-arity (path->hfile "../../data/order/spine-splits-and-joins-b.krn"))
