...
;; Node definitions
(define TERM-11-0 (terminator-node (token "*-" 'SpineTerminator 11 0)))
(define J-10-0 (token-node (token "*v" 'SpineJoin 10 0) (box-immutable TERM-11-0)))
(define J-10-1 (token-node (token "*v" 'SpineJoin 10 1) (box-immutable TERM-11-0)))
...
(define NULL-6-2 (token-node (token "*" 'NullInterpretation 6 2) (box-immutable 4c-7-1)))
...
(check-expect (path->hfile "../../data/order/spine-splits-right-joins-left-b.krn")
              (hfile (list (record "**kern" 'ExclusiveInterpretation
                           ...
                           (record "*v\t*v" 'TandemInterpretation
                                   ...
                                   10)
                           (record "*-" 'TandemInterpretation
                                   (list (token "*-" 'SpineTerminator 11 0))
                                   11))))
                                         ...
                                         (parent (token "*^" 'SpineSplit 1 0)
                                                 ...
                                                 (list (parent (token "*^" 'SpineSplit 2 1)
                                                               ...
                                                               (list (leaf (token "4c" 'SpineData 3 2))
                                                                     ...
                                                                     (leaf (token "*v" 'SpineJoin 10 1))))
                                                       (leaf (token "4c" 'SpineData 7 1))
                                                       (leaf (token "4c" 'SpineData 8 1))
                                                       (leaf (token "4c" 'SpineData 9 1))
                                                       (leaf (token "*v" 'SpineJoin 10 1))))
                                         (leaf (token "*-" 'SpineTerminator 11 0)))))))
               ...
               (hgraph (root (list (list (leaf (token "**kern" 'ExclusiveInterpretation 0 0))
                                         (parent (token "*^" 'SpineSplit 1 0)
                                                 ...
                                                 (list (parent (token "*^" 'SpineSplit 2 1)
                                                       ...
                                                       (leaf (token "*v" 'SpineJoin 10 1))))
                                         (leaf (token "*-" 'SpineTerminator 11 0)))))))
              (tokens->records (list (list (token "**kern" 'ExclusiveInterpretation 0 0))
                                (list (token "*^" 'SpineSplit 1 0))
                                (list (token "*" 'NullInterpretation 2 0)
                                      (token "*^" 'SpineSplit 2 1))
                                (list (token "4c" 'SpineData 3 0)
...
(check-expect (extract-spine-arity (path->hfile "../../data/order/spine-splits-right-joins-left-b.krn"))
