...
(check-expect (path->hfile "../../data/order/spine-splits-joins-successively.krn")
              (hfile (list (record "**kern" 'ExclusiveInterpretation
                           ...
                           (record "*\t*^" 'TandemInterpretation (list (token "*" 'NullInterpretation 2 0)
                                                       (token "*^" 'SpineSplit 2 1))
                                   2)
                           (record "4c\t4c\t4c" 'Token (list (token "4c" 'SpineData 3 0)
                           ...
                           (record "4c\t4c\t4c" 'Token (list (token "4c" 'SpineData 5 0)
                                   ...
                                   5)
                           (record "*\t*v\t*v" 'TandemInterpretation (list (token "*" 'NullInterpretation 6 0)
...
(check-expect (extract-spine-arity (path->hfile "../../data/order/spine-splits-joins-successively.krn"))
