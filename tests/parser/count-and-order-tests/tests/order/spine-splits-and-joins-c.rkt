...
(define J-11-0 (token-node (token "*v" SPINE-JOIN 11 0) (box-immutable TERM-12-0)))
(define J-11-1 (token-node (token "*v" SPINE-JOIN 11 1) (box-immutable TERM-12-0)))
(define NULL-10-0 (token-node (token "*" NULL-INTERPRETATION 10 0) (box-immutable J-11-0)))
...
(define S-6-0 (split-node (token "*^" SPINE-SPLIT 6 0)
                          (box-immutable 4c-7-0)
                          (box-immutable 4c-7-1)))
(define NULL-6-1 (token-node (token "*" NULL-INTERPRETATION 6 1) (box-immutable 4c-7-2)))
(define 4c-5-0 (token-node (token "4c" SPINE-DATA 5 0) (box-immutable S-6-0)))
(define 4c-5-1 (token-node (token "4c" SPINE-DATA 5 1) (box-immutable NULL-6-1)))
...
(define NULL-2-1 (token-node (token "*" NULL-INTERPRETATION 2 1) (box-immutable 4c-3-1)))
...
(define NULL-11-2 (token-node (token "*" NULL-INTERPRETATION 11 2) (box-immutable TERM-12-1)))
(define NULL-10-3 (token-node (token "*" NULL-INTERPRETATION 10 3) (box-immutable NULL-11-2)))
...
(define J-6-2 (token-node (token "*v" SPINE-JOIN 6 2) (box-immutable 4c-7-3)))
(define J-6-3 (token-node (token "*v" SPINE-JOIN 6 3) (box-immutable 4c-7-3)))
(define J-6-4 (token-node (token "*v" SPINE-JOIN 6 4) (box-immutable 4c-7-3)))
(define 4c-5-2 (token-node (token "4c" SPINE-DATA 5 2) (box-immutable J-6-2)))
(define 4c-5-3 (token-node (token "4c" SPINE-DATA 5 3) (box-immutable J-6-3)))
(define 4c-5-4 (token-node (token "4c" SPINE-DATA 5 4) (box-immutable J-6-4)))
...
(define S-2-2 (split-node (token "*^" SPINE-SPLIT 2 2)
