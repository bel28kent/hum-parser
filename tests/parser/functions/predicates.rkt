...
; kern?
(check-expect (kern? (token "**kern" EXCLUSIVE-INTERPRETATION 0 0))  #t)
(check-expect (kern? (token "**dynam" EXCLUSIVE-INTERPRETATION 0 0)) #f)

; dynam?
(check-expect (dynam? (token "**dynam" EXCLUSIVE-INTERPRETATION 0 0)) #t)
(check-expect (dynam? (token "**kern" EXCLUSIVE-INTERPRETATION 0 0))  #f)
