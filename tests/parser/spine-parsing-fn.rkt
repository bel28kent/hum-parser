...
(define order-path (string-append HUM-PARSER-PATH "/tests/parser/count-and-order-tests/data/order/"))
(define SIM (path->hfile (string-append order-path "spine-splits-simultaneous.krn")))
(define 3-J (path->hfile (string-append order-path "more-than-two-spine-joins.krn")))
(define S-J-A (path->hfile (string-append order-path "spine-splits-and-joins-a.krn")))
(define S-J-B (path->hfile (string-append order-path "spine-splits-and-joins-b.krn")))
(define S-J-C (path->hfile (string-append order-path "spine-splits-and-joins-c.krn")))
...
(check-expect (gspine-wrapper (tokens-by-spine (list
