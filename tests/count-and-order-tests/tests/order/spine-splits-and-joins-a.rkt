...
;; Node Definitions
(define TERM-NODE (terminator-node (box-immutable (token "*-" SPINE-TERMINATOR 16 0))))
(define J-15-2 (token-node (token "*v" SPINE-JOIN 15 1) TERM-NODE))
(define J-15-1 (token-node (token "*v" SPINE-JOIN 15 0) TERM-NODE))
(define J-14-3 (token-node (token "*v" SPINE-JOIN 14 2) (box-immutable J-15-2)))
(define J-14-2 (token-node (token "*v" SPINE-JOIN 14 1) (box-immutable J-15-2)))
(define NULL-14 (token-node (token "*" NULL-INTERPRETATION 14 0) (box-immutable J-15-1)))
(define 4c-13-3 (token-node (token "4c" SPINE-DATA 13 2) (box-immutable J-14-3)))
(define 4c-13-2 (token-node (token "4c" SPINE-DATA 13 1) (box-immutable J-14-2)))
(define 4c-13-1 (token-node (token "4c" SPINE-DATA 13 0) (box-immutable NULL-14)))
(define 4c-12-3 (token-node (token "4c" SPINE-DATA 12 2) (box-immutable 4c-13-3)))
(define 4c-12-2 (token-node (token "4c" SPINE-DATA 12 1) (box-immutable 4c-13-2)))
(define 4c-12-1 (token-node (token "4c" SPINE-DATA 12 0) (box-immutable 4c-13-1)))
(define 4c-11-3 (token-node (token "4c" SPINE-DATA 11 2) (box-immutable 4c-12-3)))
(define 4c-11-2 (token-node (token "4c" SPINE-DATA 11 1) (box-immutable 4c-12-2)))
(define 4c-11-1 (token-node (token "4c" SPINE-DATA 11 0) (box-immutable 4c-12-1)))
(define S-10-3 (split-node (token "*^" SPINE-SPLIT 10 2) (box-immutable 4c-11-2)
                                                         (box-immutable 4c-11-3)))
(define J-10-2 (token-node (token "*v" SPINE-JOIN 10 1) (box-immutable 4c-11-1)))
(define J-10-1 (token-node (token "*v" SPINE-JOIN 10 0) (box-immutable 4c-11-1)))
(define 4c-9-3 (token-node (token "4c" SPINE-DATA 9 2) (box-immutable S-10-3)))
(define 4c-9-2 (token-node (token "4c" SPINE-DATA 9 1) (box-immutable J-10-2)))
(define 4c-9-1 (token-node (token "4c" SPINE-DATA 9 0) (box-immutable J-10-1)))
...
(define J-6-3 (token-node (token "*v" SPINE-JOIN 6 2) (box-immutable 4c-7-3)))
(define J-6-2 (token-node (token "*v" SPINE-JOIN 6 1) (box-immutable 4c-7-3)))
(define S-6-1 (split-node (token "*^" SPINE-SPLIT 6 0) (box-immutable 4c-7-1)
...
(define 4c-5-1 (token-node (token "4c" SPINE-DATA 5 0) (box-immutable S-6-1)))
...
(define S-2-2 (split-node (token "*^" SPINE-SPLIT 2 1) (box-immutable 4c-3-2)
                                                       (box-immutable 4c-3-3)))
(define N-2-1 (token-node (token "*" NULL-INTERPRETATION 2 0) (box-immutable 4c-3-1)))
(define S-1 (split-node (token "*^" SPINE-SPLIT 1 0) (box-immutable N-2-1)
                                                     (box-immutable S-2-2)))
