...
;; Node Definitions
(define TERM-0 (terminator-node (box-immutable (token "*-" SPINE-TERMINATOR 12 0))))
(define NULL-11 (token-node (token "*" NULL-INTERPRETATION 11 0) TERM-0))
(define NULL-10 (token-node (token "*" NULL-INTERPRETATION 10 0)
                            (box-immutable NULL-11)))
(define 4c-9-1 (token-node (token "4c" SPINE-DATA 9 0) (box-immutable NULL-10)))
(define 4c-8-1 (token-node (token "4c" SPINE-DATA 8 0) (box-immutable 4c-9-1)))
(define 4c-7-1 (token-node (token "4c" SPINE-DATA 7 0) (box-immutable 4c-8-1)))
(define J-6-1 (token-node (token "*v" SPINE-JOIN 6 0) (box-immutable 4c-7-1)))
(define J-6-2 (token-node (token "*v" SPINE-JOIN 6 1) (box-immutable 4c-7-1)))
(define J-6-3 (token-node (token "*v" SPINE-JOIN 6 2) (box-immutable 4c-7-1)))
(define 4c-5-1 (token-node (token "4c" SPINE-DATA 5 0) (box-immutable J-6-1)))
(define 4c-5-2 (token-node (token "4c" SPINE-DATA 5 1) (box-immutable J-6-2)))
(define 4c-5-3 (token-node (token "4c" SPINE-DATA 5 2) (box-immutable J-6-3)))
...
(define S-2 (split-node (token "*^" SPINE-SPLIT 2 1) (box-immutable 4c-3-2)
                                                     (box-immutable 4c-3-3)))
(define S-1 (split-node (token "*^" SPINE-SPLIT 1 0) (box-immutable NULL-2)
                                                     (box-immutable S-2)))
(define KERN-0 (token-node (token "**kern" EXCLUSIVE-INTERPRETATION 0 0)
                           (box-immutable S-1)))

(define TERM-1 (terminator-node (box-immutable (token "*-" SPINE-TERMINATOR 12 1))))
...
(define J-10-2 (token-node (token "*v" SPINE-JOIN 10 2) (box-immutable J-11-2)))
(define NULL-10-4 (token-node (token "*" NULL-INTERPRETATION 10 3)
                              (box-immutable J-11-2)))
(define 4c-9-2 (token-node (token "4c" SPINE-DATA 9 1) (box-immutable J-10-1)))
(define 4c-9-3 (token-node (token "4c" SPINE-DATA 9 2) (box-immutable J-10-2)))
(define 4c-9-4 (token-node (token "4c" SPINE-DATA 9 3) (box-immutable NULL-10-4)))
(define 4c-8-2 (token-node (token "4c" SPINE-DATA 8 1) (box-immutable 4c-9-2)))
(define 4c-8-3 (token-node (token "4c" SPINE-DATA 8 2) (box-immutable 4c-9-3)))
(define 4c-8-4 (token-node (token "4c" SPINE-DATA 8 3) (box-immutable 4c-9-4)))
(define 4c-7-2 (token-node (token "4c" SPINE-DATA 7 1) (box-immutable 4c-8-2)))
(define 4c-7-3 (token-node (token "4c" SPINE-DATA 7 2) (box-immutable 4c-8-3)))
(define 4c-7-4 (token-node (token "4c" SPINE-DATA 7 3) (box-immutable 4c-8-4)))
(define NULL-6 (token-node (token "*" NULL-INTERPRETATION 6 4) (box-immutable 4c-7-2)))
(define S-6 (split-node (token "*^" SPINE-SPLIT 6 5) (box-immutable 4c-7-3)
                                                     (box-immutable 4c-7-4)))
(define 4c-5-4 (token-node (token "4c" SPINE-DATA 5 3) (box-immutable NULL-6)))
(define 4c-5-5 (token-node (token "4c" SPINE-DATA 5 4) (box-immutable S-6)))
(define 4c-4-4 (token-node (token "4c" SPINE-DATA 4 3) (box-immutable 4c-5-4)))
(define 4c-4-5 (token-node (token "4c" SPINE-DATA 4 4) (box-immutable 4c-5-5)))
(define 4c-3-4 (token-node (token "4c" SPINE-DATA 3 3) (box-immutable 4c-4-4)))
(define 4c-3-5 (token-node (token "4c" SPINE-DATA 3 4) (box-immutable 4c-4-5)))
(define NULL-2-3 (token-node (token "*" NULL-INTERPRETATION 2 2) (box-immutable 4c-3-4)))
(define NULL-2-4 (token-node (token "*" NULL-INTERPRETATION 2 3) (box-immutable 4c-3-5)))
(define S-1-2 (split-node (token "*^" SPINE-SPLIT 1 1) (box-immutable NULL-2-3)
                                                       (box-immutable NULL-2-4)))
