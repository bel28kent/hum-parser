...
(check-expect (path->hfile "../../data/count/one-spine-three-splits.krn")
              (hfile (list (record "**kern"
                           ...
                           (record "*\t*\t*^" TOKEN (list (token "*" NULL-INTERPRETATION 7)
                                                          ...
                                                          (token "*^" SPINE-SPLIT 7))
                                   7)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 8)
                                                                (token "4c" SPINE-DATA 8)
                                                                (token "4c" SPINE-DATA 8)
                                                                (token "4c" SPINE-DATA 8))
                                   8)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 9)
                                                                (token "4c" SPINE-DATA 9)
                                                                (token "4c" SPINE-DATA 9)
                                                                (token "4c" SPINE-DATA 9))
                                   9)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 10)
                                                                (token "4c" SPINE-DATA 10)
                                                                (token "4c" SPINE-DATA 10)
                                                                (token "4c" SPINE-DATA 10))
                                   10)
                           (record "=2\t=2\t=2\t=2" TOKEN (list (token "=2" MEASURE 11)
                                                                (token "=2" MEASURE 11)
                                                                (token "=2" MEASURE 11)
                                                                (token "=2" MEASURE 11))
                                   11)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 12)
                                                                (token "4c" SPINE-DATA 12)
                                                                (token "4c" SPINE-DATA 12)
                                                                (token "4c" SPINE-DATA 12))
                                   12)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 13)
                                                                (token "4c" SPINE-DATA 13)
                                                                (token "4c" SPINE-DATA 13)
                                                                (token "4c" SPINE-DATA 13))
                                   13)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 14)
                                                                (token "4c" SPINE-DATA 14)
                                                                (token "4c" SPINE-DATA 14)
                                                                (token "4c" SPINE-DATA 14))
                                   14)
                           (record "=3\t=3\t=3\t=3" TOKEN (list (token "=3" MEASURE 15)
                                                                (token "=3" MEASURE 15)
                                                                (token "=3" MEASURE 15)
                                                                (token "=3" MEASURE 15))
                                   15)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 16)
                                                                (token "4c" SPINE-DATA 16)
                                                                (token "4c" SPINE-DATA 16)
                                                                (token "4c" SPINE-DATA 16))
                                   16)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 17)
                                                                (token "4c" SPINE-DATA 17)
                                                                (token "4c" SPINE-DATA 17)
                                                                (token "4c" SPINE-DATA 17))
                                   17)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 18)
                                                                (token "4c" SPINE-DATA 18)
                                                                (token "4c" SPINE-DATA 18)
                                                                (token "4c" SPINE-DATA 18))
                                   18)
                           (record "*\t*\t*v\t*v" TOKEN (list (token "*" NULL-INTERPRETATION 19)
                           ...
                           (record "*\t*v\t*v" TOKEN (list (token "*" NULL-INTERPRETATION 20)
                                                           ...
                                                           (token "*v" SPINE-JOIN 20))
                                   20)
                           (record "*v\t*v" TOKEN (list (token "*v" SPINE-JOIN 21)
                                                        (token "*v" SPINE-JOIN 21))
                                   21)
                           (record "==" TOKEN (list (token "==" MEASURE 22)) 22)
                           (record "*-" TOKEN (list (token "*-" SPINE-TERMINATOR 23)) 23))))
...
(check-expect (lolot->lor (list (list (token "**kern" EXCLUSIVE-INTERPRETATION 0))
              ...
              (list (record "**kern"
                    ...
                    (record "*k[]" TOKEN (list (token "*k[]" KEY-SIG 2)) 2)
                    (record "*a:" TOKEN (list (token "*a:" KEY-LABEL 3)) 3)
                    (record "*M3/4" TOKEN (list (token "*M3/4" MEASURE 4)) 4)
                    (record "*^" TOKEN (list (token "*^" SPINE-SPLIT 5)) 5)
                    (record "*\t*^" TOKEN (list (token "*" NULL-INTERPRETATION 6)
                                                (token "*^" SPINE-SPLIT 6))
                            6)
...
(check-expect (ab-hgraph->lolot
              ...
              (list (list (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                    ...
                    (list (token "==" MEASURE 22))
                    (list (token "*-" SPINE-TERMINATOR 23))))
(check-expect (hfile->ab-hgraph (path->hfile "../../data/count/one-spine-three-splits.krn") ab-hgraph)
              (ab-hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                           (leaf (token "*clefG2" CLEF 1))
                                           (leaf (token "*k[]" KEY-SIG 2))
                                           (leaf (token "*a:" KEY-LABEL 3))
