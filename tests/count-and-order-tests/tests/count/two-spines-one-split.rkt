...
(check-expect (path->hfile "../../data/count/two-spines-one-split.krn")
              (hfile (list (record "**kern\t**kern"
                           ...
                           (record "*\t*\t*^" TOKEN (list (token "*" NULL-INTERPRETATION 6)
                                                          ...
                                                          (token "*^" SPINE-SPLIT 6))
                                   6)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 7)
                           ...
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 9)
                                                                ...
                                                                (token "4c" SPINE-DATA 9))
                                   9)
                           (record "=2\t=2\t=2\t=2" TOKEN (list (token "=2" MEASURE 10)
                                                                (token "=2" MEASURE 10)
                                                                (token "=2" MEASURE 10)
                                                                (token "=2" MEASURE 10))
                                   10)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 11)
                           ...
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 13)
                                                                ...
                                                                (token "4c" SPINE-DATA 13))
                                   13)
                           (record "=3\t=3\t=3\t=3" TOKEN (list (token "=3" MEASURE 14)
                                                                (token "=3" MEASURE 14)
                                                                (token "=3" MEASURE 14)
                                                                (token "=3" MEASURE 14))
                                   14)
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 15)
                           ...
                           (record "4c\t4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 17)
                                                                ...
                                                                (token "4c" SPINE-DATA 17))
                                   17)
                           (record "*\t*\t*v\t*v" TOKEN (list (token "*" NULL-INTERPRETATION 18)
                                                              (token "*" NULL-INTERPRETATION 18)
                                                              (token "*v" SPINE-JOIN 18)
                                                              (token "*v" SPINE-JOIN 18))
                                   18)
                           (record "*v\t*v\t*" TOKEN (list (token "*v" SPINE-JOIN 19)
                                                           (token "*v" SPINE-JOIN 19)
                                                           (token "*" NULL-INTERPRETATION 19))
                                   19)
                           (record "==\t==" TOKEN (list (token "==" MEASURE 20)
                                                        (token "==" MEASURE 20))
                                   20)
                           (record "*-\t*-" TOKEN (list (token "*-" SPINE-TERMINATOR 21)
...
(check-expect (ab-hgraph->lolot
              ...
              (list (list (token "**kern" EXCLUSIVE-INTERPRETATION 0)
                    ...
                    (list (token "*-" SPINE-TERMINATOR 21)
                          (token "*-" SPINE-TERMINATOR 21))))
(check-expect (hfile->ab-hgraph (path->hfile "../../data/count/two-spines-one-split.krn")
                                ab-hgraph)
              (ab-hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                           (leaf (token "*clefG2" CLEF 1))
                                           (leaf (token "*k[]" KEY-SIG 2))
