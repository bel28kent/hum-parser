...
(check-expect (path->hfile "../../data/count/two-spines-no-splits.krn")
              (hfile (list (record "**kern\t**kern"
                           ...
                           (record "*M3/4\t*M3/4" TOKEN (list (token "*M3/4" TIME-SIG 4)
                                   ...
                                   4)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 5)
                                                        (token "4c" SPINE-DATA 5))
                                   5)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 6)
                                                        (token "4c" SPINE-DATA 6))
                                   6)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 7)
                                                        (token "4c" SPINE-DATA 7))
                                   7)
                           (record "=2\t=2" TOKEN (list (token "=2" MEASURE 8)
                                                        (token "=2" MEASURE 8))
                                   8)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 9)
                                                        (token "4c" SPINE-DATA 9))
                                   9)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 10)
                                                        (token "4c" SPINE-DATA 10))
                                   10)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 11)
                                                        (token "4c" SPINE-DATA 11))
                                   11)
                           (record "=3\t=3" TOKEN (list (token "=3" MEASURE 12)
                                                        (token "=3" MEASURE 12))
                                   12)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 13)
                                                        (token "4c" SPINE-DATA 13))
                                   13)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 14)
                                                        (token "4c" SPINE-DATA 14))
                                   14)
                           (record "4c\t4c" TOKEN (list (token "4c" SPINE-DATA 15)
                                                        (token "4c" SPINE-DATA 15))
                                   15)
                           (record "==\t==" TOKEN (list (token "==" MEASURE 16)
                                                        (token "==" MEASURE 16))
                                   16)
                           (record "*-\t*-" TOKEN (list (token "*-" SPINE-TERMINATOR 17)
...
(check-expect (lolot->lor (list  (list (token "**kern" EXCLUSIVE-INTERPRETATION 0)
                                 ...
                                 (list (token "*clefG2" CLEF 1)
                                       (token "*clefG2" CLEF 1))
                                 (list (token "*k[]" KEY-SIG 2) (token "*k[]" KEY-SIG 2))
                                 (list (token "*a:" KEY-LABEL 3) (token "*a:" KEY-LABEL 3))
                                 (list (token "*M3/4" TIME-SIG 4) (token "*M3/4" TIME-SIG 4))
                                 (list (token "4c" SPINE-DATA 5) (token "4c" SPINE-DATA 5))
                                 (list (token "4c" SPINE-DATA 6) (token "4c" SPINE-DATA 6))
                                 (list (token "4c" SPINE-DATA 7) (token "4c" SPINE-DATA 7))
                                 (list (token "=2" MEASURE 8) (token "=2" MEASURE 8))
                                 (list (token "4c" SPINE-DATA 9) (token "4c" SPINE-DATA 9))
                                 (list (token "4c" SPINE-DATA 10) (token "4c" SPINE-DATA 10))
                                 (list (token "4c" SPINE-DATA 11) (token "4c" SPINE-DATA 11))
                                 (list (token "=3" MEASURE 12) (token "=3" MEASURE 12))
                                 (list (token "4c" SPINE-DATA 13) (token "4c" SPINE-DATA 13))
                                 (list (token "4c" SPINE-DATA 14) (token "4c" SPINE-DATA 14))
                                 (list (token "4c" SPINE-DATA 15) (token "4c" SPINE-DATA 15))
                                 (list (token "==" MEASURE 16) (token "==" MEASURE 16))
                                 (list (token "*-" SPINE-TERMINATOR 17) (token "*-" SPINE-TERMINATOR 17))))
...
(check-expect (ab-hgraph->lolot
              ...
              (list  (list (token "**kern" EXCLUSIVE-INTERPRETATION 0)
                     ...
                     (list (token "==" MEASURE 16) (token "==" MEASURE 16))
                     (list (token "*-" SPINE-TERMINATOR 17) (token "*-" SPINE-TERMINATOR 17))))
(check-expect (hfile->ab-hgraph (path->hfile "../../data/count/two-spines-no-splits.krn") ab-hgraph)
              (ab-hgraph (root (list (list (leaf (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                           (leaf (token "*clefG2" CLEF 1))
                                           (leaf (token "*k[]" KEY-SIG 2))
                                           (leaf (token "*a:" KEY-LABEL 3))
