...
(check-expect (path->hfile "../../data/count/three-spines-no-splits.krn")
              (hfile (list (record "**kern\t**kern\t**kern"
                                   ...
                                   (list (token "**kern" EXCLUSIVE-INTERPRETATION 0)
                                         ...
                                         (token "**kern" EXCLUSIVE-INTERPRETATION 0))
                                   0)
                           (record "*clefG2\t*clefG2\t*clefG2" TOKEN (list (token "*clefG2" CLEF 1)
                                                                           (token "*clefG2" CLEF 1)
                                                                           (token "*clefG2" CLEF 1))
                                   1)
                           (record "*k[]\t*k[]\t*k[]" TOKEN (list (token "*k[]" KEY-SIG 2)
                                                                  (token "*k[]" KEY-SIG 2)
                                                                  (token "*k[]" KEY-SIG 2))
                                   2)
                           (record "*a:\t*a:\t*a:" TOKEN (list (token "*a:" KEY-LABEL 3)
                                                               (token "*a:" KEY-LABEL 3)
                                                               (token "*a:" KEY-LABEL 3))
                                   3)
                           (record "*M3/4\t*M3/4\t*M3/4" TOKEN (list (token "*M3/4" TIME-SIG 4)
                                                                     (token "*M3/4" TIME-SIG 4)
                                                                     (token "*M3/4" TIME-SIG 4))
                                   4)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 5)
                                                            (token "4c" SPINE-DATA 5)
                                                            (token "4c" SPINE-DATA 5))
                                   5)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 6)
                                                            (token "4c" SPINE-DATA 6)
                                                            (token "4c" SPINE-DATA 6))
                                   6)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 7)
                                                            (token "4c" SPINE-DATA 7)
                                                            (token "4c" SPINE-DATA 7))
                                   7)
                           (record "=2\t=2\t=2" TOKEN (list (token "=2" MEASURE 8)
                                                            (token "=2" MEASURE 8)
                                                            (token "=2" MEASURE 8))
                                   8)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 9)
                                                            (token "4c" SPINE-DATA 9)
                                                            (token "4c" SPINE-DATA 9))
                                   9)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 10)
                                                            (token "4c" SPINE-DATA 10)
                                                            (token "4c" SPINE-DATA 10))
                                   10)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 11)
                                                            (token "4c" SPINE-DATA 11)
                                                            (token "4c" SPINE-DATA 11))
                                   11)
                           (record "=3\t=3\t=3" TOKEN (list (token "=3" MEASURE 12)
                                                            (token "=3" MEASURE 12)
                                                            (token "=3" MEASURE 12))
                                   12)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 13)
                                                            (token "4c" SPINE-DATA 13)
                                                            (token "4c" SPINE-DATA 13))
                                   13)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 14)
                                                            (token "4c" SPINE-DATA 14)
                                                            (token "4c" SPINE-DATA 14))
                                   14)
                           (record "4c\t4c\t4c" TOKEN (list (token "4c" SPINE-DATA 15)
